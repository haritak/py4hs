...
def addPluto():
    '''
    '''
    possibleYes = ["yes", "y", "ναι", "ν", 
            "si", "da", "ok", "οκ", "βάλε τον",
            "βάλτον"]
    possibleNo = ["no", "n", "οχι", "όχι", "ο", "ό",
            "ήντε μπρε λες", "από που κι ως που"]

   
    answer=''
    while answer not in possibleYes and answer not in possibleNo:
        print("Να θεωρήσουμε τον Πλούτωνα πλανήτη (ν/ο);")
        answer = input().lower()

    return answer in possibleYes
